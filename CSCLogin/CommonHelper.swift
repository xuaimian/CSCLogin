...
extension UIColor {
    ...
    @nonobjc static let x333333 = UIColor.colorWithRGBA(red: 190, green: 190, blue: 190, alpha: 1)

    @nonobjc static let x4FB0FF = UIColor.colorWithRGBA(red: 37, green: 169, blue: 218, alpha: 1)
